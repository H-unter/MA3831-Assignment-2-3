...
\def\doctitle{Capstone Project - Financial News Sentiment Analysis and Price Modelling}
...
\begin{document}
    ...
    \input{sec_3_data_wrangling.tex}
    \input{sec_4_ml.tex}
    \input{sec_5_conclusion.tex}
